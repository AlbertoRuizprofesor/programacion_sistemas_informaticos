...
class Socio:
    ...
    def __init__(self):
        ...
        self.antiguedad = int(input("Introduzca años en el club: "))
...
class Club:
    ...
    def veterano(self):
        ...
        elif (self.socio2.retornar_antiguedad() > self.socio1.retornar_antiguedad() and
            self.socio2.retornar_antiguedad() > self.socio3.retornar_antiguedad()):
