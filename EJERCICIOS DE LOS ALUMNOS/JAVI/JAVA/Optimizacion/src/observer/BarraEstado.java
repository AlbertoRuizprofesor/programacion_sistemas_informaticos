...
class BarraEstado implements Observer {
	...
	// Método de la interfaz Observer que se llama cuando se actualiza el estado del
	// observable
	@Override
	public void actualizar(int cantidadVendida) {
		// Se imprime un mensaje indicando que se vendió un producto y se muestra el
		// total de ventas
