...
public class Sobrecarga {
	...
	public String mostrar(String nombre, int edad) {
		return "sobrecarga nombre: "+nombre+" "+edad;
	}
	
	public String mostrar(String nombre, int edad, double ingresos) {
		return "sobrecarga nombre: "+nombre+" "+edad+" "+ingresos;
	}
	
	public String mostrar(String nombre) {
		return "sobrecarga nombre: "+nombre;
	}	
}
