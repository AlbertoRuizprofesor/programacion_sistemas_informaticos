...
class Banco:
    ...
    def __init__(self):
        ...
        self.cliente4=Cliente("Francisco")
        self.cliente5=Cliente("Beatriz")
    ...
    def operar(self):
        ...
        self.cliente4.depositar(450)
        self.cliente4.extraer(150)
        self.cliente5.depositar(250)
        self.cliente5.extraer(150)


    def depositos_totales(self):
        total=(self.cliente1.retornar_saldo()+self.cliente2.retornar_saldo()+self.cliente3.retornar_saldo()+
               self.cliente4.retornar_saldo()+self.cliente5.retornar_saldo())
