#Plantear una clase Club y otra clase Socio.La clase Socio debe tener los siguientes atributos: nombre y la antigüedad en el club (en años).En el método 
# __init__ de la clase Socio pedir la carga por teclado del nombre y su antigüedad.
