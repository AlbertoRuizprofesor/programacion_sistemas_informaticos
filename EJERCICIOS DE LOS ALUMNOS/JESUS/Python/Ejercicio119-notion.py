...
def ordenar_imprimir(v1,v2,v3): #funcion con parametros y condicional 
    if v1<v2 and v1<v3:
        if (v2<v3):
            print(v1,v2,v3)
        else:
...
def cargar(): #funcion que pide numeros por consola 
    num1=int(input("Ingrese primer valor:"))
    num2=int(input("Ingrese segundo valor:"))
    num3=int(input("Ingrese tercer valor:"))
    ordenar_imprimir(num1,num2,num3)# invocacion de la primera funcion 
