#Ejercicio de nominas e IRPF
#me pide dos inputs, uno la nomina, otro el irpf, vamos a usar 2 funciones, uno que calcule el irpf, el otro que me diga el neto que voy a cobrar, además
#quiero saber el bruto anual, el irpf anual y el neto anual, teniendo en cuenta que son 14 pagas.

# nomina=float(input("Ingrese el valor de su nomina: "))
# irpf=float(input("Ingrese su porcentaje de IRPF: "))

# def retencion(nomina,irpf):
    
#     return nomina*(irpf/100)

# def neto(nomina,irpf):

#     return nomina - 


# retencion(nomina,irpf)
# neto(nomina,retencion)
