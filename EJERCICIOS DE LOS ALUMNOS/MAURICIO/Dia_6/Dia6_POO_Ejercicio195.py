class Alumnos:
    ...
    def menu(self):
        opcion = 0
        while opcion != 4:
            print("\n\033[33m1-\033[0m Cargar alumnos")
            print("\033[33m2-\033[0m Listar alumnos")
            print(
                "\033[33m3-\033[0m Listado de alumnos con notas mayores o iguales a 7"
            )
            print("\033[33m4-\033[0m Finalizar programa\n1")

            opcion = int(input("\033[34mIngrese su opcion:\033[0m "))
            if opcion == 1:
                self.cargar()
            elif opcion == 2:
                self.listar()
