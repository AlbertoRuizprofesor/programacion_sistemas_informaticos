#Ejercicio 160: Crear un diccionario que permita almacenar 5 artículos, utilizar como clave el nombre de productos y como valor el precio del mismo. Desarrollar además las funciones de:
...
def imprimir_mayor100(productos):
    print("Listado de productos con precios mayores a 100.")
    for nombre in productos:
        if productos[nombre]>100:
            print(nombre)
            
            
productos=imprimir_diccionario()
imprimir(productos)
