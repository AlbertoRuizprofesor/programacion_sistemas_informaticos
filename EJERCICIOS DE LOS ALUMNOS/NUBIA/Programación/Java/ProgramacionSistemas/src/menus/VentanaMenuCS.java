...
public class VentanaMenuCS extends JFrame {
    ...
    public VentanaMenuCS() {
        ...
        itemCopiar=crearItem(menuHerra, "Copiar");
        itemPegar=crearItem(menuAyuda, "Pegar");
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new VentanaMenuCS().setVisible(true));
    }
}