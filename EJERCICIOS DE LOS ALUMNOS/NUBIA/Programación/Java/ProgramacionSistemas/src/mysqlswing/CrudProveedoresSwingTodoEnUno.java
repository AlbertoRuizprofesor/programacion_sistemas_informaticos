 ...
 *   edad   VARCHAR(2)   NULL
 */
public class CrudProveedoresSwingTodoEnUno extends JFrame {
...
//con este codigo guardamos los datos de la tabla indicando fila y columna
  ...
  //creamos la referencia al objeto jtable
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(CrudProveedoresSwingTodoEnUno::new);
    }

    // =========================
    // CONSTRUCTOR
    // =========================
    public CrudProveedoresSwingTodoEnUno() {
