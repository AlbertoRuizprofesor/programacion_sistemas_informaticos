...
class Socio:
    def __init__(self):
        ...
        self.antiguedad = int(input("Ingresa cuántos años llevas en el club (cifra numérica): "))

    def imprimir(self):
        print(f"{self.nombre}. Lleva {self.antiguedad} años")
...
class Club:
    ...
    def mayor_antiguedad(self):
        ...
        elif self.socio2.retonar_antiguedad() > self.socio3.retornar_antiguedad():
