...
//con este codigo guardamos los datos de la tabla indicando fila y columna
  ...
  //creamos la referencia al objeto jtable
    ...
    private void configurarEventos() {
        ...
        tabla.getSelectionModel().addListSelectionListener(e -> {
            if (!e.getValueIsAdjusting() && tabla.getSelectedRow() != -1) {
                ...
                Object precio = modelo.getValueAt(fila, 3);
        ...
        btnBuscar.addActionListener(e -> {
            ...
            if (fila == null) {
                ...
                txtPrecio.setText(fila[3] == null ? "" : fila[3]);
            }
        });
    ...
    private boolean validarCampos(boolean requiereId, boolean exigeNifNombre) {
        ...
        if (exigeNifNombre) {
            if (precio.isEmpty() || nombre.isEmpty()) {
                JOptionPane.showMessageDialog(this, "precio y Nombre son obligatorios.");
                return false;
            }
        }
        ...
        if (!precio.isEmpty() && precio.length() > 2) {
    ...
    private boolean actualizar(int id, String nif, String nombre) {
